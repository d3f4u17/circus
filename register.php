...
<header>
  ...
  -->
          ...
          <ul class=" btn-nav-nav navbar-nav nav-flex-icons">
            <li class="nav-item">
      ...
      <form class="panel" method="post" action="register.php">
          ...
          <div class="panel-content">
              <div class="waves-effect waves-light" style="display: flex; align-items: center; justify-content: center">
                  <img style="background-color: darkgray;" src="img/deexit.png" height="100px" width="100px" alt="">
              </div>
              <h2 style="text-align: center;" class="text-black">Рыгестрация</h2>
              <?php include('errors.php'); ?>
              <div class="mailpass">
                  <div class="md-form">
                      <i class="fas fa-envelope prefix"></i>
                      <input type="email" name="email" value="<?php echo $email; ?>" id="inputIconEx1" class="form-control">
                      <label for="inputIconEx1">Введите адрес E-mail</label>
                  </div>
                  <div class="md-form">
                      <i class="fas fa-user prefix"></i>
                      <input  type="text" name="username" value="<?php echo $username; ?>" id="inputIconEx1" class="form-control">
                      <label for="inputIconEx1">Введите логин</label>
                  </div>
                  <div class="md-form">
                      <i class="fas fa-lock prefix"></i>
                      <input type="password" name="password_1" id="inputValidationEx2" class="form-control validate">
                      <label for="inputValidationEx2" data-error="wrong" data-success="right">Введите пароль</label>
                  </div>
                  <div class="md-form">
                      <i class="fas fa-lock prefix"></i>
                      <input type="password" name="password_2" id="inputValidationEx2" class="form-control validate">
                      <label for="inputValidationEx2" data-error="wrong" data-success="right">Подтвердите пароль</label>
                  </div>
                  <div class="md-form">
                      <ul class="navbar-nav nav-flex-icons">
                        <li class="nav-item">
                        <button type="submit" class="btn btn-reg btn-indigo nav-link waves-effect waves-light" name="reg_user"> Зарыгестрироваться </button>
                        </li> 
                      </ul>
                  </div>
